...
<body class="bg-green-600">
    <header class="w-full bg-white flex items-center justify-between px-4 py-2 shadow">
        <div class="text-4xl">
            <span class="text-green-700">HONGDANG</span>
            <span class="text-orange-400">BANK</span>
        </div>
        <a href="<?= ROOT ?>/logout" class="flex items-center gap-2 px-5 py-2 bg-red-600 font-medium border border-[2px] border-black rounded-lg transition-color duration-300 ease-linear hover:bg-red-800" type="submit">Đăng xuất<svg fill="#000000" height="20px" width="20px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 384.971 384.971" xml:space="preserve">
