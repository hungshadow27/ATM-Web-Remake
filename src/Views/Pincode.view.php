...
<div class="w-full max-w-screen-sm mx-auto flex flex-col items-start mt-2 bg-white px-10 py-5 rounded shadow text-lg shadow">
    <h1 class="w-full text-2xl font-semibold text-center">Nhập mã pin để tiếp tục</h1>
    <form action="<?= ROOT ?>/pincode/validatePincode" method="POST" class="w-full space-y-6 mt-8">
        <div class="w-full flex items-center bg-green-700 border border-[2px] border-black rounded-lg">
            <label for="pin1" class="px-4 text-center text-white">Mã PIN</label>
