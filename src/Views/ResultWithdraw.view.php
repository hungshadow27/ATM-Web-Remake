...
<div class="w-full max-w-screen-md mx-auto flex flex-col items-start mt-2 bg-white px-10 py-5 rounded shadow text-lg shadow">
    <h1 class="w-full text-2xl font-semibold text-center">Kết quả rút tiền</h1>
    <div class="w-full space-y-4 mt-8">
        ...
        <div class="w-full flex items-center border-b-[1px] border-gray-300">
            ...
            <input disabled type="text" name="receiver-user" value="Rút tiền thành công" class="flex-1 ps-4 py-3 bg-white text-green-600 font-medium">
        </div>
        <div class="text-center pt-5">
            <a href="<?= ROOT ?>/withdraw" class="px-5 py-3 bg-orange-400 border border-[2px] border-black rounded-lg transition-color duration-300 ease-linear hover:bg-orange-600">Rút tiếp</a>
        </div>
    </div>
